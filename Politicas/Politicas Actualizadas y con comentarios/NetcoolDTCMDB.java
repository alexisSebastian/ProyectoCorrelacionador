...
//comprobamos el clli si es de equipo o tarjeta
...
if (Length(clli) == 11) {
   ...
   log("11 DIGITOS: " + WSParams);
    ...
    _Keys = WSNewSubObject(_Model,"Keys");
    _Keys['Query'] = 'display.name= "'+clli+''+'/'+''+repisa+''+'/'+slot+''+'/'+puerto+'"';
    ...
    log("MAS DE 11 DIGITOS: " + WSParams);
