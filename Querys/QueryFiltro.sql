(Agent like 'Cisco CPN' and AlertGroup in ('BFD connectivity down', 'BFD neighbour loss', 'BGP link down', 'BGP neighbour loss', 'efp down' ,'lag down',
...
'netw.PhysicalLink', 'PollerProblem', 'NodeRebooted', 'HandShaking', 'ReachabilityProblem')) or (Agent like 'ADVA' and AlertGroup in ('AIS', 'FLT', 'PSU', 'ALLSYNCREF', 
...
'RXJABBER', 'RX-JABBER')) or (Agent like 'RAD' and AlertGroup in ('Alarm indication signal (ais)', 'link down', 'Loss of frame (lof)', 'Loss of signal (los)', 'Loss of signal (los) at far end (los-fe)', 
